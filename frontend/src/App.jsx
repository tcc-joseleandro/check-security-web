...
import WafAnalyzer from './components/WafScan'; // Novo componente
...
function App() {
  ...
  if (currentPage === 'security-url') return renderWithBackButton(<SecurityAnalyzer />);
  if (currentPage === 'docker-scan') return renderWithBackButton(<DockerScanner />);
  if (currentPage === 'waf-analyze') return renderWithBackButton(<WafAnalyzer />);
  ...
  return (
    <div style={dashboardStyle}>
      ...
      <div style={gridStyle}>
        <div style={{ ...cardStyle, border: '2px solid #38bdf8' }} onClick={() => setCurrentPage('security-url')}>
          <ShieldCheck size={54} color="#38bdf8" />
          <h3 style={{ fontSize: '1.3rem', margin: 0 }}>Análise de Segurança de URL</h3>
          <p style={{ fontSize: '0.9rem', color: '#94a3b8' }}>Headers e Cookies</p>
        </div>
        ...
        <div style={{ ...cardStyle, border: '2px solid #38bdf8' }} onClick={() => setCurrentPage('docker-scan')}>
          <Box size={54} color="#38bdf8" />
          <h3 style={{ fontSize: '1.3rem', margin: 0 }}>Scan de Imagem Docker</h3>
          <p style={{ fontSize: '0.9rem', color: '#94a3b8' }}>Vulnerabilidades de camadas</p>
        </div>

        {/* BOTÃO 4: WAF (AGORA ATIVO) */}
        <div 
        ...
        >
          <GlobeLock size={54} color="#38bdf8" />
          <h3 style={{ fontSize: '1.3rem', margin: 0 }}>Verificar WAF em URL</h3>
          <p style={{ fontSize: '0.9rem', color: '#94a3b8' }}>Identificar firewalls ativos</p>
        </div>
      </div>
